...
var fileNamePackages = fs_extra_1.default.readdirSync(__dirname + "/@generators/scripts/packages/templates");
var fileNameHooks = fs_extra_1.default.readdirSync(__dirname + "/@generators/scripts/hooks/templates");
var fileNameComponentUi = fs_extra_1.default.readdirSync(__dirname + "/@generators/scripts/component-ui/templates");
var fileNameUtils = fs_extra_1.default.readdirSync(__dirname + "/@generators/scripts/utils/templates");
var fileNameUtilsValidate = fs_extra_1.default.readdirSync(__dirname + "/@generators/scripts/utils/templates/validate");
var fileNameUtilsFormatting = fs_extra_1.default.readdirSync(__dirname + "/@generators/scripts/utils/templates/formatting");
var fileNameUtilsCache = fs_extra_1.default.readdirSync(__dirname + "/@generators/scripts/utils/templates/cache");
var fileNameRoutingComponent = fs_extra_1.default.readdirSync(__dirname + "/@generators/scripts/components-routing/templates");
