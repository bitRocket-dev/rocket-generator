...
var customUtils = function (name, dirPath) { return __awaiter(void 0, void 0, void 0, function () {
    var dir, localDir, path;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                dir = name === 'fetch' || name === 'helpers' || name === 'time'
                    ? "./src/@sdk/utils/" + name
                    : "./src/@sdk/utils/" + dirPath + "/" + name;
                localDir = name === 'fetch' || name === 'helpers' || name === 'time'
