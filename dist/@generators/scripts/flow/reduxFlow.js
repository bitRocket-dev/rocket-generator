...
exports.reduxFlow = void 0;
var fs_extra_1 = require("fs-extra");
var sagas_1 = require("./templates/sagas");
...
var splitStringUtility_1 = require("./templates/splitStringUtility");
var reduxFlow = function (name, reducer) { return __awaiter(void 0, void 0, void 0, function () {
    function writeFileErrorHandler(err) {
        if (err)
            throw err;
    }
    var names, nameUpper, dir, dir2, dirSync;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                names = splitStringUtility_1.splitString(name);
                if (!names[1])
                    throw new Error('You must include a component name.');
                nameUpper = names[1].charAt(0).toUpperCase() + names[1].slice(1);
                dir = "./src/@sdk/redux-modules/" + nameUpper;
                dir2 = dir + "/" + names[0];
...
//# sourceMappingURL=reduxFlow.js.map